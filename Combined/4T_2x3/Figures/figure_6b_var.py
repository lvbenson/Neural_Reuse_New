...
def all_var_data():
    ...
    for i, file in enumerate(files):
        ...
        if np.min(fits) > 0.8:
            ...
            var_data = np.load("./Combined/4T_2x5/Data/NormVar_IP_{}.npy".format(run_num))
            plt.scatter(np.arange(1, 11), var_data, c='blue', s=5, alpha=0.7)
            var_data = np.load("./Combined/4T_2x5/Data/NormVar_CP_{}.npy".format(run_num))
            plt.scatter(np.arange(1, 11), var_data, c='green', s=5, alpha=0.7)
            var_data = np.load("./Combined/4T_2x5/Data/NormVar_LW_{}.npy".format(run_num))
            plt.scatter(np.arange(1, 11), var_data, c='red', s=5, alpha=0.7)
            var_data = np.load("./Combined/4T_2x5/Data/NormVar_MC_{}.npy".format(run_num))
            plt.scatter(np.arange(1, 11), var_data, c='yellow', s=5, alpha=0.7)
...
def plot_var_analysis(run_num):
    ...
    # load and plot data
    var_data = 1 - np.load("./Combined/4T_2x5/Data/NormVar_IP_{}.npy".format(run_num))
    plt.scatter(np.arange(1, 11) - 0.1, var_data, s=50, alpha=0.7, c="xkcd:tomato", label="IP")
    
    var_data = 1 - np.load("./Combined/4T_2x5/Data/NormVar_CP_{}.npy".format(run_num))
    plt.scatter(np.arange(1, 11) - 0.5, var_data, s=50, alpha=0.7, c="xkcd:azure", label="CP")
    
    var_data = 1 - np.load("./Combined/4T_2x5/Data/NormVar_LW_{}.npy".format(run_num))
    plt.scatter(np.arange(1, 11), var_data, s=50, alpha=0.7, c="xkcd:teal green", label="LW")

    var_data = 1 - np.load("./Combined/4T_2x5/Data/NormVar_MC_{}.npy".format(run_num))
    plt.scatter(np.arange(1, 11) + 0.05, var_data, s=50, alpha=0.7, c="xkcd:orange", label="LW")
    ...
    plt.tight_layout()
    plt.savefig("./Combined/4T_2x5/Figures/figure_6_Var_0.pdf")
    plt.show()
    ...
    for i, file in enumerate(files):
        ...
        if np.min(fits) > 0.8:
            ...
            ipp = 1 - np.load("./Combined/4T_2x5/Data/NormVar_IP_" + str(ind) + ".npy")
    ...
    plt.savefig("./Combined/4T_2x5/Figures/figure_6_var_reuse.pdf")
    plt.show()
