...
def fitness_traces(dir):
    ...
    plt.ylabel("Fitness")
    plt.tight_layout()
    #plt.savefig("./Combined/4T_2x3/Figures/figure_2_fitnesstraces.pdf")
    plt.show()
    


#fitness_traces("./Combined/4T_2x3/Data")
fitness_traces("/Users/lvbenson/Research_Projects/Neural_Reuse_New/Combined/4T_2x3/Data")
"""
plt.plot(bfs[best_run], "xkcd:reddish", label=best_label)  # "xkcd:ultramarine")
plt.title("Combined sensors/motors")
    #plt.legend()
