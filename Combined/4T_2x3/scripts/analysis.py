...
gens = len(np.load(dir+"/average_history2x3_0.npy"))
#print(gens)
gs=len(np.load(dir+"/best_individual2x3_0.npy"))
...
for i in range(start,finish):
    af[index] = np.load(dir+"/average_history2x3_"+str(i)+".npy")
    bf[index] = np.load(dir+"/best_history2x3_"+str(i)+".npy")
    bi[index] = np.load(dir+"/best_individual2x3_"+str(i)+".npy")
