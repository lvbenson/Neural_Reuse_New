...
IP_3x20 = np.load("./Combined/4T_3x20/Data/" + "IP_reuse" + ".npy")
CP_3x20 = np.load("./Combined/4T_3x20/Data/" + "CP_reuse" + ".npy")
LW_3x20 = np.load("./Combined/4T_3x20/Data/" + "LW_reuse" + ".npy")
MC_3x20 = np.load("./Combined/4T_3x20/Data/" + "MC_reuse" + ".npy")
...
df3 = pd.DataFrame({'Network Size': ['3x5','3x5','3x5','3x5','3x10','3x10','3x10','3x10','3x20','3x20','3x20','3x20'],
'Reuse Proportion': [np.average(IP_3x5),np.average(CP_3x5),np.average(LW_3x5),np.average(MC_3x5),
np.average(IP_3x10),np.average(CP_3x10),np.average(LW_3x10),np.average(MC_3x10),
np.average(IP_3x20),np.average(CP_3x20),np.average(LW_3x20),np.average(MC_3x20)],
'Task': ["IP","CP","LW","MC","IP","CP","LW","MC","IP","CP","LW","MC"]
})
...
'Task': ["IP","CP","LW","MC","IP","CP","LW","MC","IP","CP","LW","MC","IP","CP","LW","MC"]
})

#print(dfnew.head())
fig, axs = plt.subplots(1,2)
#ax1 = fig.add_subplot(121)
sns.catplot(x='Network Size',y='Reuse Proportion',data=df2,ax=axs[0],hue='Task',s=8,legend_out=True)

#ax2 = fig.add_subplot(122)
sns.catplot(x='Network Size',y='Reuse Proportion',data=df3,ax=axs[1],hue='Task',s=8,legend_out=True)
