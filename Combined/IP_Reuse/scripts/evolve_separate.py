...
ga = mga.Microbial(fitnessFunctionInv, popsize, genesize, recombProb, mutatProb, demeSize, generations, boundaries)
ga.run()
ga.showFitness()
...
def fitnessFunctionCP(genotype):
    ...
    if fitness2 < 0.0:
        fitness2 = 0.0
    return fitness2
ga = mga.Microbial(fitnessFunctionCP, popsize, genesize, recombProb, mutatProb, demeSize, generations, boundaries)
ga.run()
ga.showFitness()
...
ga = mga.Microbial(fitnessFunctionLW, popsize, genesize, recombProb, mutatProb, demeSize, generations, boundaries)
ga.run()
ga.showFitness()
...
ga = mga.Microbial(fitnessFunctionMC, popsize, genesize, recombProb, mutatProb, demeSize, generations, boundaries)
ga.run()
ga.showFitness()
...
# Fitness function
def fitnessFunctionIVCP(genotype):
    nn = ffann.ANN(nI,nH1,nH2,nO)
    nn.setParameters(genotype,WeightRange,BiasRange)
    # Task 1
    body = invpend.InvPendulum()
...
ga = mga.Microbial(fitnessFunctionIVCP, popsize, genesize, recombProb, mutatProb, demeSize, generations, boundaries)
ga.run()
ga.showFitness()
