...
#Mountain Car
trials_position_MC = 8
trials_velocity_MC = 8
...
def simulate_individual(save_dir, run_num):
    # Common setup
    genotype = np.load("/Users/lvbenson/Research_Projects/Neural_Reuse_New/Combined/Cog_Models_Project/Data_M1/best_individual_" + "20" + ".npy")
...
individual_id = 20
simulate_individual("/Users/lvbenson/Research_Projects/Neural_Reuse_New/Combined/Cog_Models_Project/Data_M1", individual_id)
