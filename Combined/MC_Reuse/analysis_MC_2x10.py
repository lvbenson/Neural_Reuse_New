...
dir = "C:/Users/benso/Desktop/Projects/Neural_Reuse/Neural_Reuse_New/Combined/MC_Reuse/Data_2x10"
#id = str(sys.argv[1])
reps = 100
...
def find_all_lesions(dir,ind):
    ...
    bi = np.load(dir+"/best_individualMC10_"+str(ind)+".npy")
...
gens = len(np.load(dir+"/average_historyMC10_0.npy"))
#print(gens)
gs=len(np.load(dir+"/best_individualMC10_0.npy"))
...
for i in range(0,100):
    ...
    af[index] = np.load(dir+"/average_historyMC10_"+str(i)+".npy")
    bf[index] = np.load(dir+"/best_historyMC10_"+str(i)+".npy")
    bi[index] = np.load(dir+"/best_individualMC10_"+str(i)+".npy")
