...
def plot_lesion_analysis(run_num):
    ...
    for i, file in enumerate(files):
        ...
        if np.min(fits) > 0.8:
            ...
            ipp = np.load("./Combined/4T_2x10/Data/lesions_IP_" + str(ind) + ".npy")
            cpp = np.load("./Combined/4T_2x10/Data/lesions_CP_" + str(ind) + ".npy")
            lwp = np.load("./Combined/4T_2x10/Data/lesions_LW_" + str(ind) + ".npy")
            mcp = np.load("./Combined/4T_2x10/Data/lesions_LW_" + str(ind) + ".npy")
    ...
    """
    np.save("./Combined/4T_2x10/Data"+"/MC"+".npy",mc_inv)
    ...
    np.save("./Combined/4T_2x10/Data"+"/ip_cp_mc"+".npy",ip_cp_mc)
    np.save("./Combined/4T_2x10/Data"+"/ip_lw_mc"+".npy",ip_lw_mc)
    np.save("./Combined/4T_2x10/Data"+"/cp_lw_mc"+".npy",cp_lw_mc)
    np.save("./Combined/4T_2x10/Data"+"/all"+".npy",all_tasks)
    np.save("./Combined/4T_2x10/Data"+"/none"+".npy",no_tasks)
    print(most_pop)
    np.save("./Combined/4T_2x10/Data"+"/most_pop_cat"+".npy",most_pop)
    """
    ...
    for count in all_counts:
        ...
        reused_count_2.append((count[5]+count[6]+count[7]+count[8]+count[9]+count[10])/20)
        reused_count_3.append((count[1]+count[12]+count[13]+count[14])/20)
        reused_count_4.append((count[15])/20)
    ...
    np.save("./Combined/4T_2x10/Data"+"/reused_prop_2"+".npy",reused_count_2)
    np.save("./Combined/4T_2x10/Data"+"/reused_prop_3"+".npy",reused_count_3)
    np.save("./Combined/4T_2x10/Data"+"/reused_prop_4"+".npy",reused_count_4)
